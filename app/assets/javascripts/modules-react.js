...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ticket = _react2.default.createClass({
	  displayName: 'Ticket',
	...
	var TicketList = _react2.default.createClass({
	  displayName: 'TicketList',

	  render: function render() {
	    var ticketNodes = this.props.data.map(function (ticket) {
	      console.log(ticket);
	      return _react2.default.createElement(Ticket, { key: ticket.id, title: ticket.attributes.title });
	    });
	...
	var TicketBox = _react2.default.createClass({
	  displayName: 'TicketBox',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'ticketBox' },
	      _react2.default.createElement(TicketList, { data: this.state.data })
	    );
	  }
	});

	(0, _reactDom.render)(_react2.default.createElement(TicketBox, { url: '/tickets.json' }), document.getElementById('ticket-box'));
